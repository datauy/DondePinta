          ...
          pinsArray.forEach(function(feature){
            if (feature.properties) {
              ...
              if(lon&&lat){
                ...
                if(!$scope.containers["tipo-" + feature.properties.Tipo]){
                  $scope.containers["tipo-" + feature.properties.Tipo]=[];
                }
                $scope.containers["tipo-" + feature.properties.Tipo].push(layer);
                layer.on('click', function(e) {
                    $scope.selected_container = PinService.build(e.target.feature.properties);
